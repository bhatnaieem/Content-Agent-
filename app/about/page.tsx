...
import { ArrowLeft, CheckCircle2, FileSearch, PenLine, ShieldCheck, Sparkles, Target, TrendingUp, Users, History } from "lucide-react";

const capabilities = [
  { icon: FileSearch, title: "Research", text: "Find recent Web3 stories, conversations, launches and developments worth paying attention to." },
  { icon: TrendingUp, title: "Narrative Radar", text: "Surface themes gaining momentum and identify the narratives most relevant to your audience." },
  { icon: Target, title: "Prioritisation", text: "Score opportunities by relevance and impact so the strongest stories rise to the top." },
  { icon: PenLine, title: "Content Studio", text: "Turn selected stories into threads, posts, replies, quotes, polls, blog ideas and creative briefs." },
  { icon: History, title: "Content History", text: "Keep a record of generated content and publishing activity so your team's work is easy to review." },
];
  ...
  return (
    <main className="about-page">
      <div className="about-shell">
        <a href="/" className="about-back"><ArrowLeft size={15} /> Back to Web3 Pulse</a>

        <section className="about-hero">
          <div className="about-kicker"><Sparkles size={14} /> ABOUT WEB3 PULSE AI</div>
          <h1>Web3 intelligence for teams that need to move fast.</h1>
          <p>Web3 Pulse is a research and content intelligence workspace built for Web3 PR, communications and social teams. It helps you discover what matters, understand why it matters, prioritise the strongest narratives, and turn that signal into publication-ready content.</p>
          <div className="about-note"><ShieldCheck size={16} /><span><strong>Human publishing stays in control.</strong> Web3 Pulse accelerates research and content production, while your team reviews, edits and decides what gets published.</span></div>
        </section>

        <section className="about-section">
          <div className="about-section-heading"><span>01</span><div><h2>What Web3 Pulse does</h2><p>One workflow from ecosystem research to editorial output and content history.</p></div></div>
